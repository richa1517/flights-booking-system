...
export default function UpdateFlights() {
    ...
    const{sourceLocation, destinationLocation, departureTime, arrivalTime, date, fare, availableSeats} = flight;
    ...
    const onSubmit= async (e)=>{
        e.preventDefault();
        await axios.put(`http://localhost:8081/flight/${fId}`,flight);
  ...
  return (
    ...
    <div className="container">
        <h2 className="text-center m-4">Update Flight</h2>
        <div className="row my-5 mb-5">
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
    
                

                <h4>Enter the flightId:</h4>
                <form onSubmit={(e)=>onSubmitId(e)}>
                <div className="mt-5">
                <label htmlFor="flightId" className="form-label">FlightId</label>
                <input type={"text"} className="form-control" placeholder="Enter your flightId" name="userId" value={fId} onChange={(e)=> setFlightId(e.target.value)}/>
                </div>
                <button type="submit" className="btn btn-outline-primary mt-5">Submit</button>
                <Link className="btn btn-outline-danger mt-5 mx-2" to="/adminhomepage">Cancel</Link>
            ...
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
                ...
                <div className="mb-3">
                    ...
                    <input type={"text"} className="form-control" placeholder="Enter the destination location" name="destinationLocation" value={destinationLocation} onChange={(e)=>onInputChange(e)}/>
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type={"text"} className="form-control" placeholder="Enter the available seats" name="avaialableSeats" value={availableSeats} onChange={(e)=>onInputChange(e)}/>
                </div>
